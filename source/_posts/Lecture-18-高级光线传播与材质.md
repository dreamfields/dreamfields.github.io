  ...
  - 实现方法（其中一种）
    ...
    - Stage3——local density estimation
      ...
      - 分析：为何光子映射是一个有偏的方法？
        ...
        - 正确的计算密度的方法应该是取一个很小的面积，计算里面的光子数，再用光子数/面积，即 ​​​​​，而我们的计算方法是去确定一个 N，通过 ​​​​​​​​​​​​​​​​​ 来估计。结论——只有 ​​ 无限小时结果才是正确的。如果发射的光子数越多，取一个着色点相同数量的 N 个光子，所占的面积就更小（更加集中），结果就会更准确。因此当发射的总光子数 Q 趋近于无穷时，得到的画面就是完全正确的了。​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
