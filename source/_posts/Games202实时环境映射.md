...
![](Games202实时环境映射/Untitled%201.png)
...
![](Games202实时环境映射/Untitled%207.png)
...
![](Games202实时环境映射/Untitled%208.png)
...
- 至此我们有了三个变量:基础反射率r0,roughness α 和角度 θ ,三维的预计算仍然是一个存储量爆炸的结果,因此我们还要想办法减少参数量.(PS:在这里我们认为反射角,入射角,half vector可以用一个角 θ 代替).于是将Schlick近似代入后半部分积分，基础反射R0被拆出积分式，需要预计算的两个量就只有roughness α 和角度 θ
    ...
    ![](Games202实时环境映射/Untitled%2011.png)
    
- 可以将预计算结果绘制成一张纹理，在使用时进行查询即可。
    
    ![](Games202实时环境映射/Untitled%2012.png)
    

另外补充一点工业界对于积分的做法：将积分写成求和，这也是在UE引擎里面所使用的环境光技术

![](Games202实时环境映射/Untitled%2013.png)
...
![](Games202实时环境映射/Untitled%2014.png)
...
![](Games202实时环境映射/Untitled%2015.png)
...
![](Games202实时环境映射/Untitled%2016.png)
...
![](Games202实时环境映射/Untitled%2017.png)
...
![](Games202实时环境映射/Untitled%2024.png)
...
![](Games202实时环境映射/Untitled%2025.png)
...
![](Games202实时环境映射/Untitled%2026.png)
...
![](Games202实时环境映射/Untitled%2027.png)
...
![](Games202实时环境映射/Untitled%2028.png)

# PRT方法总结

![](Games202实时环境映射/Untitled%2029.png)
...
![](Games202实时环境映射/Untitled%2033.png)
...
![](Games202实时环境映射/Untitled%2034.png)

![](Games202实时环境映射/Untitled%2035.png)

但是小波也有自己的缺陷：不支持旋转（使用球谐函数进行表示时，由于球谐函数具有**simple rotation**的性质，所以支持光源的旋转）。

![](Games202实时环境映射/Untitled%2036.png)
